...
class TestLinearIntegration:
    ...
    def test_telegram_webhook_simulation(self, linear_api_key: str, team_id: str):
        ...
        ⚠️  WARNING: This test creates REAL Linear issues in your workspace!
        The test issue title: "Bug in authentication flow"
        This is NOT a real bug - it's generated by this test to verify the integration.
        ...
        # NOTE: This test message creates a REAL Linear issue (e.g., MOR-26)
        # The "Bug in authentication flow" is NOT a real bug - just test data
        telegram_message = {
            "message_id": 12345,
            "from": {
                "id": 123456789,
