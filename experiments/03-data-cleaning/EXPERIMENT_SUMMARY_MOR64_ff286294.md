...
- **Change:** Simplify normalize_email by reusing parameter
  ...
  - Fewer variables to track, more Pythonic
- **Score:** 100.0 (25.0/25.0/25.0/25.0)
...
3. **Pythonic Style:** Reusing parameters after transformation is idiomatic and makes code more concise
...
- More Pythonic to reuse parameter
